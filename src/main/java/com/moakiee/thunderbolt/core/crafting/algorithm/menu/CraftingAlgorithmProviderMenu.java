...
public final class CraftingAlgorithmProviderMenu extends AEBaseMenu implements ISubMenu {
    public static final MenuType<CraftingAlgorithmProviderMenu> TYPE =
            ForgeMenuTypeBuilderExtension.buildUnregistered(MenuTypeBuilder
            ...
            , new ResourceLocation(ThunderboltCore.MODID, "crafting_algorithm_provider"));
