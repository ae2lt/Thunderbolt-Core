...
当前是 **Minecraft Forge 1.20.1** 分支。如需 Minecraft 1.21.1 与 NeoForge 版本，请查看 [`main`](https://github.com/ae2lt/Thunderbolt-Core/tree/main) 分支。
...
- 版本：`2.0.0-beta.2`
- Maven 坐标：`com.moakiee.thunderbolt:thunderbolt-forge-1.20.1:2.0.0-beta.2`
- 可分发 JAR：`build/libs/thunderbolt-forge-1.20.1-2.0.0-beta.2.jar`
